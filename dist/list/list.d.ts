...
export declare class BaseListComponent implements OnInit, OnChanges {
    ...
    columns: BaseTableColumn<BaseModel>[];
    ...
    doSearch: (model: ModelConstructor<BaseModel>, text: string, count: number) => Promise<(BaseModel & HasMacroBreakdown)[]>;
    /** Perform search filtering based on the breakdown filter meta data */
    doFilterByBreakdown: (filter: BreakdownFilterMeta[]) => Promise<(BaseModel & HasMacroBreakdown)[]>;
